...
string(JSON validation_schema GET "${output}" cli input_validation schema)
string(JSON validation_schema_version GET "${output}" cli input_validation schema_version)
string(JSON validation_scope_count LENGTH "${output}" cli input_validation scopes)
string(JSON validation_scope_0 GET "${output}" cli input_validation scopes 0)
string(JSON validation_scope_1 GET "${output}" cli input_validation scopes 1)
...
string(JSON timestep_min GET "${output}" input parameters timestep exclusive_minimum)
string(JSON output_freq_min GET "${output}" input parameters output_freq minimum)
string(JSON t_relaxation GET "${output}" input parameters t_relaxation default)
string(JSON t_relaxation_min GET "${output}" input parameters t_relaxation exclusive_minimum)
...
if(NOT validation_schema_version EQUAL 1)
    message(FATAL_ERROR "Unexpected validation schema version: ${validation_schema_version}")
endif()
if(
    NOT validation_scope_count EQUAL 2
    OR NOT validation_scope_0 STREQUAL "portable"
    OR NOT validation_scope_1 STREQUAL "installed"
)
    message(FATAL_ERROR "Unexpected validation scopes: ${output}")
endif()
...
if(NOT nstep_min EQUAL 1)
    message(FATAL_ERROR "Unexpected nstep minimum: ${nstep_min}")
endif()
if(NOT nstep_max EQUAL 2147483647)
    message(FATAL_ERROR "Unexpected nstep maximum: ${nstep_max}")
endif()
if(NOT timestep_min EQUAL 0)
    message(FATAL_ERROR "Unexpected timestep minimum: ${timestep_min}")
endif()
if(NOT output_freq_min EQUAL 0)
    message(FATAL_ERROR "Unexpected output frequency minimum: ${output_freq_min}")
endif()
if(NOT t_relaxation_min EQUAL 0)
    message(FATAL_ERROR "Unexpected t_relaxation minimum: ${t_relaxation_min}")
endif()
