...
TEST_F(TestParameterFileSection, processHeader)
{
    ...
    EXPECT_EQ(nonCoulombicsSection.getNonCoulombType(), settings::NonCoulombType::LJ);
    ...
    nonCoulombicsSection.processHeader(lineElements, *_engine);
    EXPECT_EQ(nonCoulombicsSection.getNonCoulombType(), settings::NonCoulombType::BUCKINGHAM);
    ...
    nonCoulombicsSection.processHeader(lineElements, *_engine);
    EXPECT_EQ(nonCoulombicsSection.getNonCoulombType(), settings::NonCoulombType::MORSE);
...
TEST_F(TestParameterFileSection, processSectionNonCoulombics)
{
    ...
    std::vector<std::string> lineElements = {"0", "1", "1.22", "234.3", "324.3"};
    NonCoulombicsSection     nonCoulombicsSection;
    nonCoulombicsSection.setNonCoulombType(settings::NonCoulombType::LJ);
    ...
    lineElements = {"0", "1", "1.22", "234.3", "324.3"};
    nonCoulombicsSection.setNonCoulombType(settings::NonCoulombType::BUCKINGHAM);
    ...
    lineElements = {"0", "1", "1.22", "234.3", "324.3"};
    nonCoulombicsSection.setNonCoulombType(settings::NonCoulombType::MORSE);
    EXPECT_NO_THROW(nonCoulombicsSection.processSection(lineElements, *_engine));
    ...
    lineElements = {"0", "1", "1.22", "234.3", "324.3"};
    nonCoulombicsSection.setNonCoulombType(settings::NonCoulombType::LJ_9_12);
