...
#include <gmock/gmock.h>   // for ElementsAre, ElementsAreArray, Elements...
...
TEST(TestBondForceField, calculateEnergyAndForces)
{
    ...
    const auto force = (::sqrt(14) - 1.2) * 3.0 / ::sqrt(14) * linearAlgebra::Vec3D(1.0, 2.0, 3.0);
    ...
    const auto virial = force * linearAlgebra::Vec3D{-1.0, -2.0, -3.0};
