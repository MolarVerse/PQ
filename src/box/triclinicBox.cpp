...
namespace molsys
{
     ...
     *
     * @details it first calculates the new box matrix, then the new box
     * dimensions and angles. By setting the box dimensions and angles the
     * transformation matrix and volume are recalculated
     *
     * @param scalingTensor
     */
