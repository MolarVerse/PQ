...
namespace molsys
{
     ...
     * @return size_t
     */
    size_t SimulationBox::getNumberOfMolecules() const
    {
     ...
     * @return size_t
     */
    size_t SimulationBox::getDegreesOfFreedom() const
    {
     ...
     * @return Atom&
     */
    Atom &SimulationBox::getAtom(const size_t index)
    {
        return *(_atoms[index]);
    }
     ...
     */
    std::vector<std::shared_ptr<Atom>> &SimulationBox::getAtoms()
    {
        return _atoms;
    }
