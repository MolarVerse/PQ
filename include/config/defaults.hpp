...
namespace defaults
{
    static constexpr char _MOLDESCRIPTOR_FILENAME_DEFAULT_[] =
        "moldescriptor.dat";
    ...
    static constexpr char _INSTANT_ENERGY_FILENAME_DEFAULT_[] =
        "default.instant_en";
    ...
    static constexpr char _RING_POLYMER_RESTART_FILENAME_DEFAULT_[] =
        "default.rpmd.rst";
    static constexpr char _RING_POLYMER_TRAJECTORY_FILENAME_DEFAULT_[] =
        "default.rpmd.xyz";
    static constexpr char _RING_POLYMER_VELOCITY_FILENAME_DEFAULT_[] =
        "default.rpmd.vel";
    static constexpr char _RING_POLYMER_FORCE_FILENAME_DEFAULT_[] =
        "default.rpmd.force";
    static constexpr char _RING_POLYMER_CHARGE_FILENAME_DEFAULT_[] =
        "default.rpmd.charge";
    static constexpr char _RING_POLYMER_ENERGY_FILENAME_DEFAULT_[] =
        "default.rpmd.en";
    ...
    static constexpr char   _COULOMB_LONG_RANGE_TYPE_DEFAULT_[] =
        "none";   // default no coulomb long range correction
    static constexpr char _NON_COULOMB_TYPE_DEFAULT_[] =
        "guff";   // default is guff
    ...
    static constexpr bool _CELL_LIST_IS_ACTIVE_DEFAULT_ =
        false;   // default is brute force routine
    static constexpr size_t _NUMBER_OF_CELLS_DEFAULT_ =
        7;   // for each dimension

    static constexpr size_t _NOSE_HOOVER_CHAIN_LENGTH_DEFAULT_ =
        3;   // default value for nose hoover chain length
    static constexpr double _BERENDSEN_THERMOSTAT_RELAXATION_TIME_ =
        0.1;   // in ps
    static constexpr double _LANGEVIN_THERMOSTAT_FRICTION_ =
        1.0e11;   // in s^-1
    static constexpr double _NOSE_HOOVER_COUPLING_FREQUENCY_ =
        1.0e3;   // in cm^-1

    static constexpr double _BERENDSEN_MANOSTAT_RELAXATION_TIME_ =
        1.0;   // in ps
    static constexpr double _COMPRESSIBILITY_WATER_DEFAULT_ =
        4.591e-5;   // default value for berendsen manostat
