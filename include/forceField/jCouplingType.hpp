...
namespace forceField
{
     ...
     *
     * @details this is a class representing a j coupling type defined in the parameter file
     *
     */
    class JCouplingType
    {
      ...
      public:
        JCouplingType(const size_t id, const double forceConstant, const double a, const double b, const double c, const double phaseShift)
            : _id(id), _forceConstant(forceConstant), _a(a), _b(b), _c(c), _phaseShift(phaseShift) {}
